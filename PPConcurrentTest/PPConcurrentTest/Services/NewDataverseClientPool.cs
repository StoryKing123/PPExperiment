...
using static DataverseClientPool;

public class NewDataverseClientPool
{
    private readonly ILogger<NewDataverseClientPool> _logger;
    private readonly List<ClientConfiguration> _clientConfigurations;

    private readonly List<ServiceClient> _clientList;
    public NewDataverseClientPool(ILogger<NewDataverseClientPool> logger, int maxConnections = 2)
    {
        _logger = logger;
